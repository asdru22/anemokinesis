...
data modify storage cotv:storage root.temp.merge.out prepend value {id:"cotv:pain_cycle",AppliableTo:["#cotv:swords",],lvl:4s,display:'{"translate":"enchantment.cotv.icon","with":[{"font":"cotv:enchants","translate":"enchantment.cotv.pain_cycle.icon"},{"font":"cotv:enchants","text":"4"}]}'}
