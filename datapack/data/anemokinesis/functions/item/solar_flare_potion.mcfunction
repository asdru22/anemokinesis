advancement revoke @s only anemokinesis:technical/item/drink_solar_flare_potion
scoreboard players set ane.temp ane.dummy 300
...
title @s actionbar [{"text":"+","color":"gray"},{"score":{"name":"ane.dummy_1","objective":"ane.dummy"},"color":"#FFB600"},{"text":"."},{"score":{"name":"ane.temp","objective":"ane.dummy"},"color":"#FFB600"},{"translate":"gui.anemokinesis.sun_drop","font":"anemokinesis:main","color":"white"},{"text":" ("},{"score":{"name":"ane.dummy_2","objective":"ane.dummy"},"color":"#FFB600"},{"text":"."},{"score":{"name":"ane.dummy_3","objective":"ane.dummy"},"color":"#FFB600"},{"text":"/"},{"score":{"name":"ane.dummy_4","objective":"ane.dummy"},"color":"#FFB600"},{"text":"."},{"score":{"name":"ane.dummy_5","objective":"ane.dummy"},"color":"#FFB600"},{"text":")"}]

tag @s add ane.tempActionbar